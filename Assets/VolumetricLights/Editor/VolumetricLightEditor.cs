...
namespace VolumetricLights {
    ...
    public partial class VolumetricLightEditor : Editor {
        ...
        VolumetricLightsPostProcessBase post;
        ...
        void OnEnable() {
            ...
            post = Misc.FindObjectOfType<VolumetricLightsPostProcessBase>();
        }
        ...
        public override void OnInspectorGUI() {
            ...
            if (raymarchPreset.intValue >= 30 && post == null) {
                EditorGUILayout.HelpBox("Consider adding the Volumetric Lights Post Process to your camera to improve performance or reduce noise appearance. Click 'Global Settings' button to add it.", MessageType.Info);
            }
            ...
            if (GUILayout.Button("Help & Tips")) {
                Application.OpenURL("https://kronnect.com/guides/volumetric-lights-2-builtin-performance-tips/");
            }
            ...
            if (castDirectLight.boolValue) {
                EditorGUI.indentLevel++;
                Camera cam = Camera.main;
                if (cam != null && cam.actualRenderingPath != RenderingPath.DeferredShading) {
